...
if [ -z "${RABBITMQ_PAN_PASSWORD}" ] || [ -z "${RABBITMQ_TARGET_HOST}" ] || \
       [ -z "${RABBITMQ_TARGET_VHOST}" ]; then
    echo 1>&2 "All of RABBITMQ_PAN_PASSWORD, RABBITMQ_TARGET_HOST, and RABBITMQ_TARGET_VHOST"
...
set_config RABBITMQ_TARGET_QUEUE ${RABBITMQ_TARGET_VHOST} ${RMQ}
